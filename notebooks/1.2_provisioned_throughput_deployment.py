...
"""Helpers for Lecture 1.2 provisioned throughput deployment workflows."""
...
catalog = "machine_learning"  # Your Unity Catalog name
schema = "ml_experimentation"
...
#         logger.error(f"Error deleting endpoint: {exc}")
#
